...
In our previous work [@weberpals2023] and for the purpose of the `smdi` R package, we categorized the implemented principled missing data investigations into three groups of diagnostics, which will be discussed in this section (Table 1).
